...
$(function () {
    ...
    function popSearch() {
        $('#populaChart').remove(); // this is my <canvas> element
        $('#container_populaChart').append('<canvas id="populaChart"><canvas>');
         var ctx = $("#populaChart").get(0).getContext("2d");
        $('#populaChart').width(900).height(400);
        $("#container_populaChart").addClass("chart-size");
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    var temp = [];
                    temp.push(data[i].females);
                    temp.push(data[i].males);
                    temp.push(data[i].total);
                    dataPopulation.push(temp);
                    
                    age.push(data[i].age);
                }
                drawchartPopulation(age, dataPopulation);
            },
    ...
    // Configuration
    // ------------------------------
    function drawchartPopulation(age, dataPopulation){
        require(
