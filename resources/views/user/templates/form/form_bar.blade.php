    ...
    <div class="content_data">
        ...
        <div class="btn_import">            
            <form action="{{ route('customer.importExcel') }}" method="post" enctype="multipart/form-data" name="form_import" id="form_import">
                ...
                <div class="example">
                    <a href="{{ URL::asset('File-template-single.xls')}}" class="btn-example">@lang('text.draw.step2.template')</a>
                </div>
                <div class="input-choose" id="import_file">
                	<input name="type_form" type="hidden" value="single"/>
        ...
        <div class="color background">
            <div class="color_data">
                <header class="header_data">@lang('text.draw.step2.bg')</header>                 
                <div class="content_input">
                    <input type="text" class="form-control colorpicker-show-input " data-preferred-format="hex" value="rgba(75, 192, 192, 0.5)">
                </div>    
                <div class="content_input">
                    <input type="text" class="form-control colorpicker-show-input " data-preferred-format="hex" value="rgba(198, 169, 222, 0.5)">
                </div>    
                <div class="content_input">
                    <input type="text" class="form-control colorpicker-show-input " data-preferred-format="hex" value="rgba(202, 30, 192, 0.5)">
                </div>    
                <div class="content_input">
                    <input type="text" class="form-control colorpicker-show-input " data-preferred-format="hex" value="rgba(179, 232, 45, 0.5)">
                </div>                          
            </div>
        </div>
        <div class="color border">
            <div class="color_border">
                <header class="header_data">@lang('text.draw.step2.border')</header>
                <div class="content_input">
                    <input type="text" class="form-control colorpicker-show-input " data-preferred-format="hex" value="rgba(75, 192, 192, 1)">
                </div>  
                <div class="content_input">
                    <input type="text" class="form-control colorpicker-show-input " data-preferred-format="hex" value="rgba(198, 169, 222, 1)">
                </div>  
                <div class="content_input">
                    <input type="text" class="form-control colorpicker-show-input " data-preferred-format="hex" value="rgba(202, 30, 192, 1)">
                </div>  
                <div class="content_input">
        ...
        <div class="text-center">
            <a href="#container_chart" class="btn btn-contact btn_drawchart wow tada">
                <div class="btn-text"><span>@lang('text.draw.step2.draw')</span></div>
            </a>
        </div>
    </div>
</div>
